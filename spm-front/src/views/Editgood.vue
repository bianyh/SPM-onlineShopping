<template>
  <div class="goods-publish-container">
    ...
    <div class="content">
        ...
        <div class="image-uploader">
          ...
          <div class="upload-area" @click="$refs.fileInput.click()">
            <span v-if="!previewImage" class="upload-text"
              >Click to change the main image</span
            >
            <template v-else>
        ...
        <div class="detail-images">
          ...
          <div class="image-uploader detail-uploader">
            ...
            <div class="upload-area" @click="$refs.detailFileInput.click()">
              <span class="upload-text">Click to add the detail image</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- 提交按钮 -->
      <button class="submit-btn" @click="handleSubmit">Edit Goods</button>
    </div>
  </div>
</template>
